...
function Home() {
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get("https://mern-backend-ss01.onrender.com/api/note/all", { withCredentials: true })
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete("https://mern-backend-ss01.onrender.com/api/note/delete/" + noteId, { withCredentials: true })
  ...
  const onSearch = async (query) => {
    try {
      const res = await axios.get("https://mern-backend-ss01.onrender.com/api/note/search/", {params: {query}, withCredentials: true })
  ...
  const updatePinned = async (noteData) => {
    ...
    try {
      const res = await axios.put("https://mern-backend-ss01.onrender.com/api/note/update-note-pinned/" + noteId, { isPinned: !noteData.isPinned }, { withCredentials: true })
