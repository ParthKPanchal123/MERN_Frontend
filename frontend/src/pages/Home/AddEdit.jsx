...
function AddEdit({ onClose, type, getAllNotes, noteData }) {
    ...
    const editNote = async () => {
        ...
        try {
            const res = await axios.post("https://mern-backend-ss01.onrender.com/api/note/edit/" + noteID, {title, content, tags}, {withCredentials: true})
    ...
    const addNewNote = async () => {
        try {
            const res = await axios.post("https://mern-backend-ss01.onrender.com/api/note/add", { title, content, tags }, { withCredentials: true })
